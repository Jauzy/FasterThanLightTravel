...
public class UserDashboardController implements Initializable {
    ...
    void logoutBtnOnClick(ActionEvent event) throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/frontend/Login.fxml")); //load file
        utility.changeWindow(stage, root);
    }
    
    @FXML
    void makeTransactionBtnOnClick(ActionEvent event) throws IOException {
        Parent child = FXMLLoader.load(getClass().getResource("MakeTransaction.fxml")); //load file
        utility.changeChildren(ContentPane, child);
    }

    @FXML
    void profileBtnOnClick(ActionEvent event) throws IOException {
        Parent child = FXMLLoader.load(getClass().getResource("Profile.fxml")); //load file
        utility.changeChildren(ContentPane, child);
    }

    @FXML
    void topupBtnOnClick(ActionEvent event) throws IOException {
        Parent child = FXMLLoader.load(getClass().getResource("TopUp.fxml")); //load file
        utility.changeChildren(ContentPane, child);
    }

    @FXML
    void transactionHistoryBtnOnClick(ActionEvent event) throws IOException {
        Parent child = FXMLLoader.load(getClass().getResource("TransactionHistory.fxml")); //load file
        utility.changeChildren(ContentPane, child);
    }
