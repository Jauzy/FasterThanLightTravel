...
public class AdminDashboardController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            Parent child = FXMLLoader.load(getClass().getResource("Admins.fxml")); //load file
    ...
    void placesBtnOnClick(ActionEvent event) throws IOException {
        Parent child = FXMLLoader.load(getClass().getResource("Places.fxml")); //load file
        utility.changeChildren(ContentPane, child);
    }

    @FXML
    void transactionBtnOnClick(ActionEvent event) throws IOException {
        Parent child = FXMLLoader.load(getClass().getResource("Transactions.fxml")); //load file
        utility.changeChildren(ContentPane, child);
    }

    @FXML
    void usersBtnOnClick(ActionEvent event) throws IOException {
        Parent child = FXMLLoader.load(getClass().getResource("Users.fxml")); //load file
        utility.changeChildren(ContentPane, child);
    }
